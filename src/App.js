        ...
        <Router>
            ...
            <Routes>
                <Route path='/' element={<div className="flex flex-col h-screen">
                    ...
                    <div className="mockup-window border border-base-300 h-full">
                        <div className="flex flex-col items-center justify-center px-4 py-16 border-t border-base-300 h-full"><Spinner/></div>
                    </div>
                    <footer className="footer mt-auto items-center p-4 bg-neutral text-neutral-content">
